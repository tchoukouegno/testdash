...
import HistoriqueAccountDetails from './HistoriqueAccountDetails';
...
export function HistoriqueAccount() {

    const location = useLocation();

    const  accountId = location.state || {}; // Les données transmises
    ...
    return(
        ...
        <div className="dashboard-container">
            ...
            <HeaderDash dashboardTitle={"Dashboard / Comptabilité / Account / Details"}/>
             ...
             <div className='dashboard-body'>
                ...
                <HistoriqueAccountDetails  accountId = {accountId}/>
