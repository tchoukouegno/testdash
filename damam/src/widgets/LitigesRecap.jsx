...
import LitigesRecapTable from './LitigesRecapTable';
...
export function LitigesRecap() {
    ...
    useEffect(() => {
        ...
        // getTransaction('https://www.damam.zeta-messenger.com/api/user_litige',token).then((response)=>{
    ...
    return(
        ...
        <div className="dashboard-container">
            ...
            <HeaderDash dashboardTitle={"Dashboard / Litiges"}/>

           

            <div className='dashboard-body'>

                <h3>Historiques Litiges</h3>
